...
const generateCreateVectorFunction =
  generateCreateBodyFunction.generateCreateVectorFunction;
...
function createPhysicsSimulator(settings) {
  ...
  var publicApi = {
    ...
    step: function () {
      ...
      var movement = getFactory(settings.dimensions, settings.debug).integrate(
        bodies,
        settings.timeStep,
    ...
    addBodyAt: function (pos) {
      ...
      var body = getFactory(settings.dimensions, settings.debug).createBody(
        pos,
      );
      bodies.push(body);
    ...
    //   var spring = new Spring(body1, body2, springLength, springCoefficient);
    //   springs.push(spring);
